...
const features = [
  ...
  { id: 'tasbih', label: 'Tasbih Counter', description: 'Digital counter for dhikr with history tracking.', icon: Activity, category: 'Spiritual' },
    ...
    <div className="container mx-auto px-4 py-12 space-y-12 max-w-6xl pb-32 lg:pb-12 animate-in fade-in duration-700">
      <header className="space-y-4">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-4xl font-black tracking-tighter text-zinc-900">Core Essentials</h1>
        </div>
